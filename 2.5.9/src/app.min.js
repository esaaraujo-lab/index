...
console.log('[GDI app] build v18.1-mediafix');
...
// ★ v18.1: anúncio de mídia compara com o ÚLTIMO elemento anunciado
//   (antes: WeakSet permanente bloqueava re-registro quando o player
//   RECRIAVA o <video> na troca de aula — cronômetro/retomada morriam)
...
// ★ v18.1: o Plyr RECRIA o <video> a cada troca de aula; agora o
//   site REANUNCIA o vídeo novo após cada troca (gdiAnnounceVideo-
//   FromDOM no switchVideo), e o cronômetro/retomada/assistido/
//   pular-intro se reconectam sozinhos no elemento novo.
// ═══════════════════════════════════════════════════════════════
...
// ═══ N1: AUTOPLAY COM CONTAGEM (com cancelar) ═══
...
function switchVideo(h){
  ...
  // v18.1: zera o cronômetro já na troca (não mostra tempo residual)
  const ntEl=document.getElementById('gdi-note-time');
  if(ntEl)ntEl.textContent='00:00';
  // v18.1: o player RECRIA o <video> na troca → reanuncia o elemento novo
  // (retomada, cronômetro, assistido, pular intro se reconectam sozinhos)
...
// EXTRAS v18.1
// ═══════════════════════════════════════════════════════════════
console.log('[GDI Extras] v18.1 ativo');

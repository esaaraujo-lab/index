...
/* ── Bootstrap modal theming ──
   ...
   não recompositava a camada, deixando o texto serrilhado/semi-
   renderizado até um clique forçar repaint. Solução: promover o
   .modal-dialog a camada própria (translateZ) quando aberto +
   will-change + blur mais leve. Repaint extra via JS no shown.bs.modal. */
...
`;document.head.appendChild(s);
// Observa trocas de tema para reinjetar nada (tokens via [data-bs-theme]) — mantém simples.

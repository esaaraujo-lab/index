...
// ★ fallback de PDF no core
function file_pdf(i,e,t,n,a,c,l){
...
// ═══════════════════════════════════════════════════════════════
// FILE_VIDEO — v19.1 (corrigido — paridade com app.min.v18.2)
// ✅ markup da playlist restaurado no template
// ✅ avanço automático: ended/complete dos players + <video> nativo
// ✅ NOTE_KEY inexistente → window.location.pathname
// ✅ window.switchVideo / renderPlaylistUI / playNextInPlaylist
// ✅ emite 'watched:changed' para os módulos sincronizarem a UI
// ═══════════════════════════════════════════════════════════════
...
// ★ v19.1: avanço automático com guarda anti-duplo-disparo (como no v18.2)
...
Bus.on('media:ready',({type,el})=>{
  ...
  el.addEventListener('ended',()=>{
    // ★ correção: NOTE_KEY não existia no core → use pathname direto
    try{GDIUser.markWatched(window.location.pathname);GDIUser.setLast(LAST_KEY());
      Bus.emit('watched:changed');}catch(_){}
...
body.gdi-fv .gdi-player-wrap{width:100%!important;}

...
console.log('[GDI app] build v10-center');
...
body.gdi-fv .gdi-study,body.gdi-fm .gdi-study{position:fixed;inset:0;z-index:8500;background:#0b0e14;overflow:auto;}
...
/* v10: sem material — layout antigo, tudo centralizado com a largura do vídeo */
body.gdi-nomat .gdi-study-grid{display:block;}
body.gdi-nomat .gdi-study-left{max-width:980px;margin:0 auto;}
body.gdi-nomat .gdi-study-left>*{max-width:980px;}
body.gdi-nomat .gdi-player-wrap{max-width:980px;margin-left:auto;margin-right:auto;}
body.gdi-nomat .gdi-viewer-footer{max-width:980px;margin-left:auto;margin-right:auto;}
body.gdi-nomat .gdi-notes{max-width:980px;margin-left:auto;margin-right:auto;}
body.gdi-nomat #gdi-playlist-wrap{max-width:980px;margin-left:auto;margin-right:auto;}
...
function gdiSetMode(m){
  ...
  // Sem painel de materiais: mantém alinhamento central no modo foco na aula
...
// Toggle: clicar de novo no modo ativo sai dele
...
// ─────────────────────────────────────────────────────────────
// MATERIAIS — v10: sem PDF → remove Dividido e Foco no material,
// classe gdi-nomat = layout antigo centralizado com largura do vídeo.
...
function gdiHideMaterialsPanel(){
  ...
  // Layout antigo: coluna única centrada com a largura do vídeo
  document.body.classList.add('gdi-nomat');
  // Se estava em "Foco no material", sai do modo
  if(document.body.classList.contains('gdi-fm')){
    document.body.classList.remove('gdi-fm');
    try{localStorage.setItem('gdi-study-mode','split')}catch(_){}
  }
  document.querySelectorAll('.gdi-mode-btn[data-mode]').forEach(b=>b.classList.remove('active'));
}

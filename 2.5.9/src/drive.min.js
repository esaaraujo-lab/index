...
console.log('[GDI app] build v4-directfetch');
...
// ─────────────────────────────────────────────────────────────
// v4 FIX: fetch DIRETO ao endpoint da pasta (sem requestListPath —
// as flags posicionais causavam POST em /0:fallback com id vazio).
// Timeout 30s/página, percorre TODAS as páginas, resolve sempre.
// ─────────────────────────────────────────────────────────────
...
// 4 varreduras em paralelo + render progressivo via onProgress.
// ─────────────────────────────────────────────────────────────
...
(async function buildPlaylist(){
  ...
  // Aninhada: playlist cresce na tela conforme as subpastas são varridas

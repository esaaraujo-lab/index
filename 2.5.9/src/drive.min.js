...
console.log('[GDI app] build v12-classicmat');
...
// ── CSS do modo estudo — v12: igual ao v6 que funcionava (SEM
// overflow:hidden no body, SEM .nomat). Sem shift, sem scrollbar dupla.
...
// ── Modos de layout (v6: simples, sem scroll-lock) + zoom no FM ──
...
// ─────────────────────────────────────────────────────────────
// MATERIAIS — v12: padrão clássico. Painel e 3 botões de modo
// SEMPRE presentes. Sem PDF → mensagem no painel, tudo o resto
// idêntico (mesma geometria, sem shift, sem scrollbar extra).
// ─────────────────────────────────────────────────────────────
...
(async function buildMaterials(){
  ...
  try{
    ...
    if(!pdfs.length){
      // Padrão clássico: mantém painel e botões; mostra mensagem de ausência
      tabsEl.innerHTML='';

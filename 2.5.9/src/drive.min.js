...
console.log('[GDI app] build v9-smartpom');
...
body.gdi-nomat .gdi-player-wrap{max-width:980px;margin:0 auto;}
body.gdi-nomat .gdi-viewer-footer{max-width:980px;margin:0 auto;}
body.gdi-nomat .gdi-notes{max-width:980px;margin:0 auto;}
body.gdi-nomat #gdi-playlist-wrap{max-width:980px;margin:0 auto;}
...
// ─────────────────────────────────────────────────────────────
// MATERIAIS — v9: sem PDF → remove Dividido E Foco no material
// (fica só Foco na aula + Assistido), vídeo full-width, modo
// salvo limpo. Mobile: botão "Abrir material" (sem iframe).
// ─────────────────────────────────────────────────────────────
...
function gdiHideMaterialsPanel(){
  ...
  // Layout antigo: coluna única centrada com largura do vídeo (classe CSS acima)
  document.body.classList.add('gdi-nomat');
  // Se estava em "Foco no material", sai do modo; se era "Foco na aula", mantém (toggle funciona)
...
(async function buildMaterials(){
  ...
  try{
    ...
    if(!pdfs.length){
      ...
      console.log('[GDI Materiais] nenhum PDF — s\u00f3 Foco na aula + Assistido');
      return;
    }

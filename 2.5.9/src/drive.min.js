...
console.log('[GDI app] build v10-layoutfix');
...
/* v10: modos de foco — trava o scroll do body; o .gdi-study é a única área rolável */
body.gdi-fv,body.gdi-fm{overflow:hidden;}
...
/* v10: sem PDF — bloco único CENTRADO, largura do vídeo como no visualizador antigo */
.gdi-study.nomat{max-width:960px;}
.gdi-study.nomat .gdi-study-grid{grid-template-columns:1fr!important;}
.gdi-study.nomat .gdi-study-left{margin:0 auto;width:100%;max-width:900px;}
...
// ─────────────────────────────────────────────────────────────
// MATERIAIS — v10: sem PDF → classe .nomat (bloco único CENTRADO
// com largura do vídeo como o visualizador antigo) + remove
// "Dividido" e "Foco no material" (fica ⚡ + ✔). Mobile: botão.
// ─────────────────────────────────────────────────────────────
...
function gdiHideMaterialsPanel(){
  ...
  // Remove "Dividido" e "Foco no material" — fica ⚡ Foco na aula + ✔ Assistido
  document.querySelector('.gdi-mode-btn[data-mode="split"]')?.remove();
  document.querySelector('.gdi-mode-btn[data-mode="fm"]')?.remove();
  // v10: bloco único CENTRADO — mesma geometria do visualizador antigo

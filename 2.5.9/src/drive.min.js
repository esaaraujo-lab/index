...
console.log('[GDI app] build v7-userstate');
...
// ─────────────────────────────────────────────────────────────
// Lista TODAS as páginas de uma pasta — fetch direto + timeout.
// ─────────────────────────────────────────────────────────────
...
// abaixo ou pasta da disciplina. Sem PDF: painel e botão somem.
// ─────────────────────────────────────────────────────────────
...
(async function buildMaterials(){
  ...
  try{
    ...
    if(!pdfs.length){
      ...
      if(document.body.classList.contains('gdi-fm'))gdiSetMode('split');
      console.log('[GDI Materiais] nenhum PDF — painel oculto');
      return;
    }
...
(function(){let n=0;const t=setInterval(()=>{
  ...
  if(v){clearInterval(t);
    ...
    GDIUser.ready().then(()=>{try{renderPlaylistUI();renderNotes();updateWatchedUI();}catch(_){}});
  }
